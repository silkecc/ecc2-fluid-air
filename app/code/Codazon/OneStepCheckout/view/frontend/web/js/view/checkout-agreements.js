...
], function (ko, $, Component, agreementsModal, customer, quote, setShippingInformationAction, setBillingAddress, setCouponCodeAction) {
    'use strict';
    ...
    return Component.extend({
        ...
        placeOrder: function(){
            if(this.validateForm('#checkout_agreements_block')){
                ...
                if($('#submit-shipping-method').length && this.validateShipping()){//if not virtual product
